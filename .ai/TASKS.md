...
| A10 | Test coverage → >30% — 🔄 In Progress. Cycle 1 ✅ DisplayStateTracker 21t. Cycle 2 ✅ config.py 67t. Cycle 3 ✅ TargetManager lifecycle 37t (update_from_yolo, update_from_night, age_targets, TTL expiry, focus-mode filter, overlap suppression, active_id cleanup). Total: 173 tests. Remaining: detectors (cv2 required — deferred), profile_io | Medium | `test_display_state_tracker.py` ✅ `test_config.py` ✅ `test_target_manager_lifecycle.py` ✅ |
