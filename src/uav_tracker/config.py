...
class Config:
    ...
    DISPLAY_BOX_ALPHA: float = 0.40
    DISPLAY_BOX_HOLD_FRAMES: int = 10
    DISPLAY_BOX_ADAPTIVE: bool = True
    DISPLAY_BOX_ALPHA_MIN: float = 0.18
    DISPLAY_BOX_ALPHA_MAX: float = 0.62
    DISPLAY_BOX_SPEED_GAIN: float = 0.20
    DISPLAY_BOX_SIZE_GAIN: float = 0.15

    IR_MODE_ENABLED: bool = False
    IR_NOISE_THRESHOLD: float = 0.020
    CONFIRMATION_FRAMES_IR_NOISE: int = 8
    IR_NOISE_UNVERIFIED_RATE: float = 0.12
    IR_NOISE_UNVERIFIED_RATE_CITY_LIGHTS: float = 0.14
    IR_NOISE_EMA_ALPHA: float = 0.25
