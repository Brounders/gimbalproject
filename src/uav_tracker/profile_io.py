...
def apply_overrides(cfg: Config, overrides: dict[str, Any]) -> Config:
    ...
    mapping = {
        ...
        'roi_assist_in_search': 'ROI_ASSIST_IN_SEARCH',
        ...
        'search_scan_interval': 'SEARCH_SCAN_INTERVAL',
        ...
        'static_target_rejection_enabled': 'STATIC_TARGET_REJECTION_ENABLED',
        'static_target_sources': 'STATIC_TARGET_SOURCES',
        'static_target_motion_thresh': 'STATIC_TARGET_MOTION_THRESH',
        'static_target_min_motion_ratio': 'STATIC_TARGET_MIN_MOTION_RATIO',
        'static_target_streak_min': 'STATIC_TARGET_STREAK_MIN',
        'static_target_penalty': 'STATIC_TARGET_PENALTY',
