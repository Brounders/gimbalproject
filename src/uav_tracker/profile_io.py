...
def apply_overrides(cfg: Config, overrides: dict[str, Any]) -> Config:
    ...
    mapping = {
        ...
        'display_box_alpha': 'DISPLAY_BOX_ALPHA',
        'display_box_adaptive': 'DISPLAY_BOX_ADAPTIVE',
        'display_box_alpha_min': 'DISPLAY_BOX_ALPHA_MIN',
        'display_box_alpha_max': 'DISPLAY_BOX_ALPHA_MAX',
        'display_box_speed_gain': 'DISPLAY_BOX_SPEED_GAIN',
        'display_box_size_gain': 'DISPLAY_BOX_SIZE_GAIN',
        'display_box_hold_frames': 'DISPLAY_BOX_HOLD_FRAMES',
        'ir_mode_enabled': 'IR_MODE_ENABLED',
        'ir_noise_threshold': 'IR_NOISE_THRESHOLD',
        'confirmation_frames_ir_noise': 'CONFIRMATION_FRAMES_IR_NOISE',
        'ir_noise_unverified_rate': 'IR_NOISE_UNVERIFIED_RATE',
        'ir_noise_unverified_rate_city_lights': 'IR_NOISE_UNVERIFIED_RATE_CITY_LIGHTS',
        'ir_noise_ema_alpha': 'IR_NOISE_EMA_ALPHA',
