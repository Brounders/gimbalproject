...
## Exit Criteria
- [x] noise-scene false-lock behavior is measurably reduced or at least more tightly bounded on the canonical problem clips
- [x] reacquire / short-gap hold behavior is less noisy and more operator-predictable without a full policy rewrite
- [x] one canonical before/after evidence loop exists for problem-clip runtime tuning
