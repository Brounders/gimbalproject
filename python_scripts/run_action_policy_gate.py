...
def compact_report(report: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "tracking_action_counts": dict(report.get("tracking_action_counts", {})),
        "decision_path_counts": dict(report.get("decision_path_counts", {})),
        "target_source_counts": dict(report.get("target_source_counts", {})),
        "target_modality_counts": dict(report.get("target_modality_counts", {})),
        "false_lock_action_counts": dict(report.get("false_lock_action_counts", {})),
        "false_lock_source_counts": dict(report.get("false_lock_source_counts", {})),
        "avg_target_reliability": round(float(report.get("avg_target_reliability", 0.0)), 4),
        "avg_target_p_present": round(float(report.get("avg_target_p_present", 0.0)), 4),
    }
...
def pair_row(source: str, scene: str, preset: str, off: dict[str, Any], on: dict[str, Any]) -> dict[str, Any]:
    ...
    row: dict[str, Any] = {
        ...
        "off_tracking_action_counts": off_c["tracking_action_counts"],
        "on_tracking_action_counts": on_c["tracking_action_counts"],
        "off_decision_path_counts": off_c["decision_path_counts"],
        "on_decision_path_counts": on_c["decision_path_counts"],
        "off_target_source_counts": off_c["target_source_counts"],
        "on_target_source_counts": on_c["target_source_counts"],
        "off_target_modality_counts": off_c["target_modality_counts"],
        "on_target_modality_counts": on_c["target_modality_counts"],
        "off_false_lock_action_counts": off_c["false_lock_action_counts"],
        "on_false_lock_action_counts": on_c["false_lock_action_counts"],
        "off_false_lock_source_counts": off_c["false_lock_source_counts"],
        "on_false_lock_source_counts": on_c["false_lock_source_counts"],
        "off_avg_target_reliability": off_c["avg_target_reliability"],
        "on_avg_target_reliability": on_c["avg_target_reliability"],
        "off_avg_target_p_present": off_c["avg_target_p_present"],
        "on_avg_target_p_present": on_c["avg_target_p_present"],
    }
    return row
...
def csv_write(path: Path, rows: list[dict[str, Any]]) -> None:
    headers = [
        ...
        "off_tracking_action_counts",
        "on_tracking_action_counts",
        "off_decision_path_counts",
        "on_decision_path_counts",
        "off_target_source_counts",
        "on_target_source_counts",
        "off_target_modality_counts",
        "on_target_modality_counts",
        "off_false_lock_action_counts",
        "on_false_lock_action_counts",
        "off_false_lock_source_counts",
        "on_false_lock_source_counts",
        "off_avg_target_reliability",
        "on_avg_target_reliability",
        "off_avg_target_p_present",
        "on_avg_target_p_present",
        "diagnostic",
        "passed",
        "fail_reasons",
        "diagnostic_reasons",
